    ...
    return (
      ...
      >
        <Link href={`/articulo/${article.attributes.slug}`}>
          <div className="absolute inset-0 bg-black bg-opacity-10 rounded-3xl flex items-center justify-between p-4 text-center hover:bg-opacity-100 md:p-24 dark:hover:bg-yellow">
            <div>
              <p>
                <FontAwesomeIcon
                  icon={faCalendarDays}
