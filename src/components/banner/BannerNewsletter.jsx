...
export default function BannerNewsletter({ className = "" }) {
  ...
  return (
    <section
      className={`p-4 rounded-2xl bg-black text-yellow dark:bg-yellow dark:text-black md:p-12 md:rounded-3xl inverse-select ${className}`}
    >
